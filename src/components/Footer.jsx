        ...
        <div className="footer-grid">
            ...
            <ul>
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    trackCTA('footer_all_services', 'click');
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    trackCTA('footer_services_webdev', 'click');
                    onViewChange('home', '#services');
                  }}
                >
                  Web Development
                </a>
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    trackCTA('footer_services_mobile', 'click');
                    onViewChange('home', '#services');
                  }}
                >
                  Mobile Apps
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    trackCTA('footer_services_ai', 'click');
                    onViewChange('home', '#services');
                  }}
                >
                  AI & Automation
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    trackCTA('footer_services_seo', 'click');
                    onViewChange('home', '#services');
                  }}
                >
                  SEO & Performance
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <a
                  href="mailto:hello@oddwebs.com"
                  onClick={() => trackCTA('footer_email_link', 'click')}
                >
                  hello@oddwebs.com
                </a>
              </li>
            ...
            <div className="footer-social" style={{ display: 'flex', gap: '12px', marginTop: '16px', flexWrap: 'wrap' }}>
              <a
                href="https://instagram.com/oddwebs"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow oddwebs on Instagram"
                title="Instagram"
                onClick={() => trackCTA('footer_social_instagram', 'click')}
              ...
              <a
                href="https://linkedin.com/company/oddwebs"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Connect with oddwebs on LinkedIn"
                title="LinkedIn"
                onClick={() => trackCTA('footer_social_linkedin', 'click')}
                style={{ color: 'var(--text-tertiary)', transition: 'color 0.3s ease' }}
              >
              ...
              <a
                href="https://twitter.com/oddwebs"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow oddwebs on X (Twitter)"
                title="X (Twitter)"
                onClick={() => trackCTA('footer_social_twitter', 'click')}
                style={{ color: 'var(--text-tertiary)', transition: 'color 0.3s ease' }}
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a
                href="https://facebook.com/oddwebs"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Like oddwebs on Facebook"
                title="Facebook"
                onClick={() => trackCTA('footer_social_facebook', 'click')}
                style={{ color: 'var(--text-tertiary)', transition: 'color 0.3s ease' }}
              >
              ...
              <a
                href="https://youtube.com/@oddwebs"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Subscribe to oddwebs on YouTube"
                title="YouTube"
                onClick={() => trackCTA('footer_social_youtube', 'click')}
                style={{ color: 'var(--text-tertiary)', transition: 'color 0.3s ease' }}
              >
